...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    // 1W View: 30min interval, specific params requested by user
    const baseIntraday30 = `https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=${ticker}&interval=30min&extended_hours=false&outputsize=compact&adjusted=false`;
